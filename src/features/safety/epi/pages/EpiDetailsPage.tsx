...
export function EpiDetailsPage() {
  ...
  const [epi, setEpi] = useState<Epi>({
    ...
    imagem_url: null,
    description: "Luva para ser utilizada na limpeza diária.",
    manufacturer: "BRASEG",
  });
      ...
      <div className="w-full space-y-6 pb-20">
        <div className="flex gap-4">
          ...
          <Header
            ...
            subTitle="Veja as informações sobre o EPI."
          />
        </div>

        {!epi && loadingEPI && loading()}
        {!epi && !loadingEPI && (
            ...
            <div className="bg-white rounded-2xl border border-slate-200 p-6">
              <div className="flex items-center mb-4 justify-between">
                ...
                <div className="self-end">
                  <LinkButton text="Nova liberação" to={`/epi/${id}/release`} />
                </div>
              </div>
