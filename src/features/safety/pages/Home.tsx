    ...
    <PageMainContainer>
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          ...
          <h1 className="text-4xl md:text-5xl font-bold text-slate-800 mb-4">QSMS</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          >
            ...
            <p className="text-slate-600">Gerencie colaboradores e suas informações</p>
          </Link>
          ...
          >
            ...
            <p className="text-slate-600">Controle de equipamentos de proteção</p>
          </Link>
        ...
        <div className="text-center m-8">
          <p className="text-sm text-slate-500">MainFlow • QSMS Controle v1.0</p>
        </div>
      </div>
    </PageMainContainer>
  );
