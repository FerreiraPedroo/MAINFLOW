    ...
    <PageMainContainer>
      <div className="max-w-4xl w-full">
        <div className="text-center mb-12">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-2xl bg-linear-to-br from-blue-500 to-blue-600 mb-6 shadow-lg shadow-blue-500/25">
            <svg
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Link
            ...
            className="group bg-white rounded-2xl border border-slate-200 p-8 hover:shadow-xl hover:shadow-slate-200/50 hover:border-blue-500 transition-all duration-300"
          >
